...
class Login(unittest.TestCase):
    ...
    @pytest.mark.navigation("Login >> Admin Dashboard >> Bookkeeping >> item ")
    @pytest.mark.description(f"Go to Select Admin panel >> click Home >> click bookkeeping >> go for Client >> click on sell >> item")
