...
class Login(unittest.TestCase):
    ...
    @pytest.mark.description(f"Go to Select Admin panel >> click Home >> click bookkeeping >> go for Client >> Banking >> Detailed Money in")


    def test_04_Go_Client_Sell(self):
        client_section = Banking_detailed_money_in(driver=self.driver)
        time.sleep(.2)
        #
